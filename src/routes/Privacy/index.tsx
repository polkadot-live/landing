    ...
    <PageContentWrapper className="thin">
      <HomeWrapper>
        <div className="legal">
          ...
          <p>
            <b>Effective Date: 20th July 2024</b>
          </p>

          <h2>1. Introduction</h2>
          <p>
            Welcome to Polkadot Live. Your privacy is important to us. This
          ...
          <h2>2. Who We Are</h2>
          <p>
            Polkadot Live is managed by JKRB Investments Limited, located at
            63/66 Hatton Garden 5f, Suite 23, London, London, England, EC1N 8LE.
            For any privacy-related questions, you can contact us at{' '}
            <a
              href="mailto:contact@polkadot-live.app"
              target="_blank"
              rel="noreferrer"
            >
              contact@polkadot-live.app
            </a>
            .
          </p>
