    ...
    <HomeWrapper>
      <div className="head">
        ...
        <div className="download">
          <div>
            <a
              href="https://github.com/polkadot-live/polkadot-live-app/releases/download/v0.11.0-beta/Polkadot-Live-0.11.0-beta-arm64.dmg"
              download
            >
          ...
          <div>
            <a
              href="https://github.com/polkadot-live/polkadot-live-app/releases/download/v0.11.0-beta/Polkadot.Live.Setup.0.11.0-beta.exe"
              download
            >
          ...
          <div>
            <a
              href="https://github.com/polkadot-live/polkadot-live-app/releases/download/v0.11.0-beta/Polkadot-Live-0.11.0-beta.AppImage"
              download
            >
