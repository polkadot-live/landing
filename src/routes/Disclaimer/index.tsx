    ...
    <PageContentWrapper className="thin">
      <HomeWrapper>
        <div className="legal">
          <h1>Disclaimer</h1>
          <p className="ySpace">
            These Terms of Use apply to <Link to="/">polkadot-live.app</Link> as
          ...
          <p className="ySpace">
            ...
            branch, subsidiary or affiliate office of Polkadot Live and such
          ...
          <p className="ySpace">
            Polkadot Live does not provide investment, legal or tax advice
          ...
          <p className="ySpace">
            ...
            Live is not responsible for any damage to your computer systems or
          ...
          <p className="ySpace">
            ...
            Live or our affiliates, or any of our directors, employees,
          ...
          <p className="ySpace">
            Polkadot Live shall not be liable to you or anybody else for any
            damages incurred in connection with any messages sent to Polkadot
            Live using ordinary E-mail or any other electronic messaging system.
          </p>
        </div>
      </HomeWrapper>
    </PageContentWrapper>
